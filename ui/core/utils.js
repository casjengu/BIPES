  ...
  */
  static makeAName (code, ext) {
    ...
    if (ext == '') {
      ...
      return desc ? `main.${ext}` : imp.length ? `my_${imp.slice(-1)[0][1]}_project.bipes.${ext}` : `my_project.bipes.${ext}`;
    }
  }
  /**Converts RGB to HEX
