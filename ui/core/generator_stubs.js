...
Blockly.Python['iot_setup'] = function(block) {
  ...
  // Fix f�r globale Variablen innerhalb einer Funktion
  // Code-Ausschnitt aus generators/python/procedures.js
  // F�gt ein 'global'- Statement f�r jede Variable, die �ber BIPES initialisiert wird, hinzu
  var globals = [];
  var workspace = block.workspace;
  var variables = Blockly.Variables.allUsedVarModels(workspace) || [];
  for (var i = 0, variable; (variable = variables[i]); i++) {
  ...
  // Alle Bl�cke aus dem aktuellen Workspace bekommen
  var blocks = workspace.getAllBlocks()
  var code = '# setup-Funktion\n';
  code += 'def setup():\n'; 
  code += Blockly.Python.INDENT + 'global dict\n' + globals + statements_setup_code; 
  // Funktion, die das dict-Objekt mit den Variablen-Namen der Module bef�llt (wird f�r den Callback-Handler ben�tigt)
  // z.B. dict[i] = i
  ...
  // Funktion, um zu schauen, ob bestimmte Blocktypen auftauchen, die ein besonderes Handling in der Hauptschleife ben�tigen
  // z.b. button.tick() f�r ein Button Modul
  for(var i=0;i<blocks.length; i++) {
    switch(blocks[i].type)
    {
      case 'iot_smart_button_init':
  ...
  // Wenn dieser Validierer implementiert wird, wird gepr�ft, ob alle Werte von diesem Block
  // sowie von ALLEN verkn�pften Bl�cken ausgef�llt sind
  // nicht brauchbar, da 1-2 Bl�cke mit optionalem Wert 
...
// Hier folgt der Generator Code f�r die ganzen Setter
...
// Ab hier beginnen die Bl�cke, die in den jeweiligen Kategorien der Toolbox angezeigt werden
...
Blockly.Python['iot_rgb_led_set_color'] = function(block) {
  ...
  // Blockvalidierung, ob alle ben�tigten Input-Felder gesetzt/gef�llt sind
...
Blockly.Python['iot_rgb_led_color_numbers'] = function(block) {
  ...
  // Wenn Rot-Wert gr��er als 100, dann wird Zahl auf 100 gesetzt
  ...
  // Wenn Gr�n-Wert kleiner als 0, dann wird Zahl auf 0 gesetzt
  if (value_green < '0') {
    this.getInputTargetBlock('green').setFieldValue(0, 'NUM');
  // Wenn Gr�n-Wert gr��er als 100, dann wird Zahl auf 100 gesetzt
  ...
  // Wenn Blau-Wert gr��er als 100, dann wird Zahl auf 100 gesetzt
...
Blockly.Python['iot_rgb_led_set_brightness'] = function(block) {
  ...
  // Wenn Wert gr��er als 100, dann wird Zahl auf 100 gesetzt
...
Blockly.Python['iot_smart_button_set_ticks'] = function(block) {
  ...
  // Wenn Wert gr��er als 1000, dann wird Zahl auf 1000 gesetzt
...
Blockly.Python['iot_smart_button_set_press_ticks'] = function(block) {
  ...
  // Wenn Wert gr��er als 2000, dann wird Zahl auf 2000 gesetzt
...
Blockly.Python['iot_dht_init'] = function(block) {
  ...
  // Hier wird geschaut, welche Dropdown-Option gew�hlt wurde und dementsprechend das Bild angepasst
...
Blockly.Python['iot_dsht_set_debounce_time'] = function(block) {
  ...
  // Wenn Wert gr��er als 3600, dann wird Zahl auf 3600 gesetzt
...
Blockly.Python['iot_motor_set_enabled'] = function(block) {
  ...
  if (value_motor_index == '') {
    ...
    // Wenn Wert gr��er als 1, dann wird Zahl auf 1 gesetzt
